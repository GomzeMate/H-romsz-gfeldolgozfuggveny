...
def Szog(m1, m2, sz):     #szögmelletti 1, szögmelletti 2, szöggel szemben lévő 
...
print(f"A(z) {a:.2f}cm, {b:.2f}cm és {c:.2f}cm oldalhosszúságú háromszög kerülete: {T:.2f}cm^2")
